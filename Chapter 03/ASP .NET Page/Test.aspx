...
<body>
    <form runat="server">
        ...
        <p align="left">
            ...
            <asp:HyperLink id="HyperLink1" runat="server" ToolTip="Click this link to visit the DataCon Services Home Page." NavigateUrl="http://www.mwt.net/~jmueller">DataCon Home Page</asp:HyperLink>
        </p>
    </form>
</body>
</html>