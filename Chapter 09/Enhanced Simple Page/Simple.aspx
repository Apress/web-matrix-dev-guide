...
<Mobile:Form id="frmWelcome" Paginate="True" runat="server">
    <p>
        Welcome to the<br />
...
Command</Mobile:Command>
        <Mobile:Link id="Link1" runat="server" NavigateUrl="#frmSecondControls" Visible="False">
            <DeviceSpecific>
...
<mobile:Form id="frmFirstControls" Paginate="True" runat="server">
...
<Mobile:Form id="frmSecondControls" Paginate="True" runat="server">
